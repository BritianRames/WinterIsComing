...
aritmeticOperation : aritmeticOperation SUBSTRACT aritmeticOperation {generateAddValueToValue($<number>1,$<number>3);}
                  | aritmeticOperation SUM aritmeticOperation {generateAddValueToValue($<number>1,$<number>3);}
